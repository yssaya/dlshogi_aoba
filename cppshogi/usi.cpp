...
void OptionsMap::init(Searcher* s) {
    ...
    (*this)["UCT_Threads11"]                = USIOption(0, 0, 256);
    (*this)["UCT_Threads12"]                = USIOption(0, 0, 256);
    (*this)["UCT_Threads13"]                = USIOption(0, 0, 256);
    (*this)["UCT_Threads14"]                = USIOption(0, 0, 256);
    (*this)["UCT_Threads15"]                = USIOption(0, 0, 256);
    (*this)["UCT_Threads16"]                = USIOption(0, 0, 256);
    (*this)["UCT_Threads17"]                = USIOption(0, 0, 256);
    (*this)["UCT_Threads18"]                = USIOption(0, 0, 256);
    ...
    (*this)["DNN_Model11"]                  = USIOption("");
    (*this)["DNN_Model12"]                  = USIOption("");
    (*this)["DNN_Model13"]                  = USIOption("");
    (*this)["DNN_Model14"]                  = USIOption("");
    (*this)["DNN_Model15"]                  = USIOption("");
    (*this)["DNN_Model16"]                  = USIOption("");
    (*this)["DNN_Model17"]                  = USIOption("");
    (*this)["DNN_Model18"]                  = USIOption("");
    ...
    (*this)["DNN_Batch_Size11"]             = USIOption(0, 0, 256);
    (*this)["DNN_Batch_Size12"]             = USIOption(0, 0, 256);
    (*this)["DNN_Batch_Size13"]             = USIOption(0, 0, 256);
    (*this)["DNN_Batch_Size14"]             = USIOption(0, 0, 256);
    (*this)["DNN_Batch_Size15"]             = USIOption(0, 0, 256);
    (*this)["DNN_Batch_Size16"]             = USIOption(0, 0, 256);
    (*this)["DNN_Batch_Size17"]             = USIOption(0, 0, 256);
    (*this)["DNN_Batch_Size18"]             = USIOption(0, 0, 256);
